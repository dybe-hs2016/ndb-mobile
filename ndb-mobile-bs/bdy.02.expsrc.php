...
<form class="form-horizontal" action="page.00.index.php?varname=bdy.02.srcrslt.php" method="post" name="form" id="form">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label" for="suche_title">Titel der Noten</label>
		<div class="col-sm-8">
	...
	<!-- Komponist -->
	<div class="form-group">
		<label class="col-sm-3 control-label" for="suche_composer">Komponist</label>
		<div class="col-sm-8">
	...
	<!-- Verlag -->
	<div class="form-group">
		<label class="col-sm-3 control-label" for="suche_publisher">Verlag</label>
		<div class="col-sm-8">
							...
							<div class="form-group">	
								<div class="col-sm-8 checkbox">
									...
									<?php 
										...
										{
											echo '<label class="checkbox col-sm-4">';
